...
function linkRawCaptureTo(type,id,rawId=activeRawCaptureId){
  if(!rawId||!id)return null;
  return linkDomainRelation({kind:'derived-from',from:{type,id},to:{type:'raw-capture',id:rawId},source:'capture'});
}
